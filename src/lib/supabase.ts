...
const publicSiteUrl = import.meta.env.VITE_SITE_URL || import.meta.env.VITE_APP_URL || 'https://hancesoo.me';
...
export const effectivePublicSiteUrl = publicSiteUrl.replace(/\/$/, '');
