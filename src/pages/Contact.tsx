        ...
        >
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-6 group cursor-pointer">
              <div className="w-14 h-14 rounded-2xl bg-orange-vibrant/10 flex items-center justify-center text-orange-vibrant group-hover:bg-orange-vibrant group-hover:text-white transition-all duration-200 group-hover:scale-[1.03]">
                <Mail size={24} />
              </div>
              <div>
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-orange-vibrant/50 transition-all duration-200 focus:bg-white/7"
                  value={name}
            ...
            <div className="space-y-2">
              ...
              <select
                className="w-full bg-midnight border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-orange-vibrant/50 transition-all duration-200 focus:bg-white/7"
                value={projectType}
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-orange-vibrant/50 transition-all duration-200 resize-none focus:bg-white/7"
                value={message}
            ...
            <button
              type="submit"
              className="w-full py-5 bg-orange-vibrant text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-orange-vibrant/90 transition-all duration-200 group hover:scale-[1.01] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-vibrant/60"
            >
