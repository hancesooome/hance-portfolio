...
import { Plus, Edit2, Trash2, Save, X, Image as ImageIcon, Upload, Database, GripVertical, LogOut } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 bg-white/5 text-white rounded-full font-medium hover:bg-white/10 transition-all"
            >
